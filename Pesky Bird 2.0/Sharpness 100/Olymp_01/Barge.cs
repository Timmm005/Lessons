...
namespace Sharpness_100.Olymp_01
{
    public record Barge
    {
        /// <summary>
        ...
        private int GetArea() =>
            IsOneRow ? GetOneRowArea() : GetTwoRowsArea();
        ...
        public static Barge CreateBarge(
            ...
            Brick z,
            bool isOneRow,
            (bool, bool, bool) flips)
        {
            var x1 = x.TryFlip(flips.Item1);
            var y1 = y.TryFlip(flips.Item2);
            var z1 = z.TryFlip(flips.Item3);
